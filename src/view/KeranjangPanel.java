...
public class KeranjangPanel extends javax.swing.JPanel {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        try {
            ...
            int cartId = cartDTO.getCartId(); // Ambil cartId dari DTO
            cartDAO.removeItemFromCart(cartId, item.getMenuItem().getId()); // Gunakan cartId, bukan userId
            loadCartItems();
            // Update cart badge
    ...
    try {
        ...
        // Tampilkan CheckoutPanel, bukan langsung clear cart
        CheckoutPanel checkoutPanel = new CheckoutPanel(parentPanel, cardLayout, user);
        parentPanel.add(checkoutPanel, "CheckoutPanel");
        cardLayout.show(parentPanel, "CheckoutPanel");
    } catch (Exception e) {
